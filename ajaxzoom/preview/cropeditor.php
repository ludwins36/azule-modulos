<?php
/**
*  Module: jQuery AJAX-ZOOM for Prestashop, cropeditor.php
*
...
$axzm_tpl_mode = false;
$axzm_path = '../axZm/';
$first_load360_dir = Tools::getValue('3dDir');
$default_thumb_size = $axzm_cms_mode ? 140 : 180;
$player_responsive = $axzm_cms_mode ? true : false;
$langugaes_array_temp = Language::getLanguages(true, Context::getContext()->shop->id);
$langugaes_array = array();

foreach ($langugaes_array_temp as $k => $v) {
    if ($k >= 0) {
        array_push($langugaes_array, $v['iso_code']);
    }
}

$langugaes_array = Tools::jsonEncode($langugaes_array);

/* If used with a CMS / Shop, the dynamically generated url for controller */
$id_360 = Tools::getValue('group');
$id_360set = Tools::getValue('id');
$token = Tools::getValue('token');
$controller_url = __PS_BASE_URI__;
$controller_url .= 'index.php?fc=module&module=ajaxzoom&controller=image360';
$controller_url .= '&ajax=1&id_360set='.$id_360set.'&id_360='.$id_360.'&token='.$token;
...
?>
    ...
    <link name="az_editor_css_scripts" rel="stylesheet" 
        href="<?php echo $axzm_path;?>axZm.css" type="text/css" media="screen">
    ...
    <link name="az_editor_css_scripts" type="text/css" 
        href="<?php echo $axzm_path;?>plugins/jCrop/css/jquery.Jcrop.css" rel="stylesheet" />
    <script type="text/javascript" src="<?php echo $axzm_path;?>plugins/jCrop/js/jquery.Jcrop.js"></script>

    <!-- Include mousewheel script -->
    <script type="text/javascript" 
        src="<?php echo $axzm_path;?>extensions/axZmThumbSlider/lib/jquery.mousewheel.min.js"></script>
    ...
    <link name="az_editor_css_scripts" 
        href="<?php echo $axzm_path;?>plugins/demo/jquery.fancybox/jquery.fancybox-1.3.4.zIndex.css" 
        type="text/css" media="screen" rel="stylesheet">
    <script type="text/javascript" 
        src="<?php echo $axzm_path;?>plugins/demo/jquery.fancybox/jquery.fancybox-1.3.4.js"></script>

    <!-- Include thumbSlider CSS && JS. -->
    <link name="az_editor_css_scripts" rel="stylesheet" 
        type="text/css" 
        href="<?php echo $axzm_path;?>extensions/axZmThumbSlider/skins/default/jquery.axZm.thumbSlider.css" />
    <script type="text/javascript" 
        src="<?php echo $axzm_path;?>extensions/axZmThumbSlider/lib/jquery.axZm.thumbSlider.js"></script>

    <!-- Set of functions for this image cropping tool -->
    <link name="az_editor_css_scripts" rel="stylesheet" 
        type="text/css" href="<?php echo $axzm_path;?>extensions/jquery.axZm.imageCropEditor.css">
    <script type="text/javascript" 
        src="<?php echo $axzm_path;?>extensions/jquery.axZm.imageCropEditor.js"></script>

    <!-- A small function to add title button which will expend to full description -->
    <link name="az_editor_css_scripts" 
        rel="stylesheet" type="text/css" 
        href="<?php echo $axzm_path;?>extensions/jquery.axZm.expButton.css">
    <script type="text/javascript" 
        src="<?php echo $axzm_path;?>extensions/jquery.axZm.expButton.js"></script>
    ...
    <link name="az_editor_css_scripts" 
        href="<?php echo $axzm_path;?>plugins/jquery.ui/themes/ajax-zoom/jquery-ui.css" 
        type="text/css" rel="stylesheet" />
    <script type="text/javascript" 
        src="<?php echo $axzm_path;?>plugins/jquery.ui/js/jquery-ui-1.8.24.custom.min.js"></script>

    <!-- CLEditor - WYSIWYG Editor (external jQuery plugin) -->
    <link name="az_editor_css_scripts" rel="stylesheet" 
        type="text/css" href="<?php echo $axzm_path;?>plugins/CLEditor/jquery.cleditor.css" />
    <script type="text/javascript" 
        src="<?php echo $axzm_path;?>plugins/CLEditor/jquery.cleditor.min.js"></script>
    <script type="text/javascript" 
        src="<?php echo $axzm_path;?>plugins/CLEditor/jquery.cleditor.table.min.js"></script>
    ...
    <link name="az_editor_css_scripts" 
        rel="stylesheet" 
        href="<?php echo $axzm_path;?>plugins/demo/prism/prism.css" type="text/css" media="screen">
    <script type="text/javascript" 
        src="<?php echo $axzm_path;?>plugins/demo/prism/prism.min.js"></script>
        ...
        <div id="aZcR_tabs-about">
            ...
            ?>
                <div class="legend" style="line-height: 60%;">About AJAX-ZOOM crop editor <br>
                    <span style="font-size: 50%">[Editor version: 
                        <?php echo $editor_version; ?>, date: <?php echo $last_updated; ?>]</span>
                </div>
            ...
            ?>
                <div id="demoOtherContent">
                    ...
                    var loadDemo = {
                        1: {
                            pathToLoad360: "<?php echo $first_load360_dir; ?>",
                            cropFileToLoad: "<?php echo $first_load_crop_json; ?>"
                        },
                        2: {
            ...
            <ol>
                <li style="margin-bottom: 10px">
                    <img src="<?php echo $axzm_path;?>icons/default/button_iPad_settings.png" 
                ...
                <li style="margin-bottom: 10px">
                    <img src="<?php echo $axzm_path;?>icons/default/button_iPad_jcrop.png" 
                        width="25" style="vertical-align: middle; margin: 2px 5px 2px 0px"> 
                    Hit the crop button to toggle crop and select region to crop. 
                </li>
                <li style="margin-bottom: 10px">
                    <img src="<?php echo $axzm_path;?>icons/default/button_iPad_fire.png" 
                        width="25" style="vertical-align: middle; margin: 2px 5px 2px 0px"> 
            ...
            ?>
                ...
                <div class="azMsg clearfix">
                    ...
                    <a href="example35_responsive.php">example35_responsive.php</a>
                </div>
                <div class="azMsg clearfix">
            ...
            <form <?php echo !$axzm_cms_mode ? 'action="'.$axzm_path.'saveCropJSON.php"' : ''; ?> id="aZcR_saveJSON">
                ...
                <script type="text/javascript">
                    jQuery('#btnSaveJSON').click(function(e){
                        e.preventDefault();
                        jQuery.post('<?php echo $save_crop_json; ?>', {json: jQuery('#aZcR_getAllThumbs').val()}, 
                        function(ret) {
