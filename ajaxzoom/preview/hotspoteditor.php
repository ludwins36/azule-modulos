<?php
/**
*  Module: jQuery AJAX-ZOOM for Prestashop, hotspoteditor.php
*
...
$controller_url .= 'index.php?fc=module&module=ajaxzoom&controller=image360&ajax=1';
$token = Tools::getValue('token');

if (Tools::getValue('3dDir')) {
    $first_load_par = '3dDir='.Tools::getValue('3dDir');
    ...
    $controller_url .= '&id_360set='.$id_360set.'&id_360='.$id_360.'&token='.$token;

    $first_load_hotspot_json = $controller_url.'&action=getHotspotJSON';
    $save_hotspot_json = $controller_url . '&action=saveHotspotJSON';
} elseif (Tools::getValue('id_media')) {
    $first_load_par = 'zoomData='.Tools::getValue('image_path');

    $id_media = Tools::getValue('id_media');
    $id_product = Tools::getValue('id_product');

    $controller_url .= '&id_media='.$id_media.'&id_product='.$id_product.'&token='.$token;

    $first_load_hotspot_json = $controller_url.'&action=getHotspotPictureJSON';
    $save_hotspot_json = $controller_url . '&action=saveHotspotPictureJSON';
}
...
<link name="az_editor_css_scripts" href="<?php echo $axzm_path;?>extensions/jquery.axZm.hotspotEditor.css" 
...
<link name="az_editor_css_scripts" href="<?php echo $axzm_path;?>plugins/jquery.ui/themes/ajax-zoom/jquery-ui.css" 
    type="text/css" rel="stylesheet" />
...
<link name="az_editor_css_scripts" rel="stylesheet" type="text/css" 
    href="<?php echo $axzm_path;?>plugins/spectrum/spectrum.css">
<script type="text/javascript" 
    src="<?php echo $axzm_path;?>plugins/spectrum/spectrum.min.js"></script>
...
<link name="az_editor_css_scripts" rel="stylesheet" 
    type="text/css" href="<?php echo $axzm_path;?>extensions/jquery.axZm.expButton.css">
<script type="text/javascript" 
...
<link name="az_editor_css_scripts" 
    ...
    type="text/css" rel="stylesheet">
<script type="text/javascript" 
    src="<?php echo $axzm_path;?>plugins/demo/jquery.fancybox/jquery.fancybox-1.3.4.pack.js"></script>
...
<script type="text/javascript" 
    src="<?php echo $axzm_path;?>extensions/jquery.axZm.openAjaxZoomInFancyBox.js"></script>
                ...
                <div id="aZhS_about-1" class="hs_subtab">
                    ...
                    <ol style="margin: 0;">
                        ...
                        <li style="margin-top: 10px">
                            ...
                            <img src="<?php echo $axzm_path;?>icons/default/button_iPad_tag.png" 
                        ...
                        <li>
                            ...
                            <img src="<?php echo $axzm_path;?>icons/default/button_iPad_hsp.png" 
                                width="25" style="vertical-align: middle; margin: 2px;">
                    ...
                    <ul style="margin: 0;">
                        <li style="margin-top: 10px">
                            <img style="position: relative; top: 12px; left: -4px;" 
                                src="<?php echo $axzm_path;?>icons/browser_ie.png" width="32" height="32"> 
