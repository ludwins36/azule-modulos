...
//        magnaFixOrders();
        ...
        if (isset($aRequest['mp']) && isset($magnaConfig['maranon']) && array_key_exists($aRequest['mp'], $magnaConfig['maranon']['Marketplaces']) && ($mp = $magnaConfig['maranon']['Marketplaces'][$aRequest['mp']]) && array_key_exists($mp, $_modules)
        ) {
            ...
            if (isset($aRequest['mp']) && $aRequest['mp'] != 'configuration' && array_key_exists($aRequest['mp'], $_modules)) {
                $_url['mp'] = $aRequest['mp'];
