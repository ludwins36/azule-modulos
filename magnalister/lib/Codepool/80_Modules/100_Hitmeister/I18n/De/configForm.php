...
MLI18n::gi()->add('hitmeister_config_account', array(
    ...
    'field' => array(
		...
		'clientkey' => array(
            'label' => 'ClientKey',
            'help' => 'Die API-Zugangsdaten bekommen Sie in Ihrem real.de Account. Dazu loggen Sie sich bitte bei real.de ein und klicken auf <b>real.de API<\/b>, im Men&uuml; links ganz unten, bei <b>Zusatzfunktionen<\/b>.'
        ),
        'secretkey' => array(
            'label' => 'SecretKey',
        ),
...
MLI18n::gi()->add('hitmeister_config_prepare', array(
    ...
    'field' => array(
        ...
        'shippingtimematching' => array(
            'label' => '',
            'matching' => array(
				'titlesrc' => 'real.de Shipping Time',
        ...
        'checkin.quantity' => array(
            ...
            'help' => 'Geben Sie hier an, wie viel Lagermenge eines Artikels auf dem Marktplatz verf&uuml;gbar sein soll.<br>
                ...
                <br>
                <strong>Beispiel:</strong> Wert auf "<i>2</i>" setzen. Ergibt &#8594; Shoplager: 10 &#8594; real.de-Lager: 8<br>
                <br>
...
MLI18n::gi()->add('hitmeister_config_price', array(
    ...
    'field' => array(
        ...
        'price.signal' => array(
            ...
            'help' => '
                Dieses Textfeld wird beim &Uuml;bermitteln der Daten zu real.de als Nachkommastelle an
...
MLI18n::gi()->add('hitmeister_config_sync', array(
    ...
    'field' => array(
        'stocksync.tomarketplace' => array(
            ...
            'help' => '
                <p>
                    ...
                    den aktuellen real.de-Lagerbestand an der Shop-Lagerbestand an (je nach Konfiguration ggf. mit Abzug).<br>
        ...
        'stocksync.frommarketplace' => array(
            'label' => 'Lagerver&auml;nderung real.de',
            'help' => '
                Wenn z. B. bei real.de ein Artikel 3 mal gekauft wurde, wird der Lagerbestand im Shop um 3 reduziert.<br><br>
        ...
        'inventorysync.price' => array(
            ...
            'help' => '
                <p>
                    Die Funktion "Automatische Synchronisierung" gleicht alle 4 Stunden (beginnt um 0:00 Uhr nachts)
                    den aktuellen Shop-Preis auf Ihren real.de-Preis an.<br>
                    Dabei werden die Werte aus der Datenbank gepr&uuml;ft und &uuml;bernommen, auch wenn die &Auml;nderungen durch z.B. 
...
MLI18n::gi()->add('hitmeister_config_orderimport', array(
    'legend' => array(
        ...
        'mwst' => 'Mehrwertsteuer',
        'orderstatus' => 'Synchronisation des Bestell-Status vom Shop zu real.de',
    ),
    'field' => array(
		'orderstatus.sync' => array(
            ...
            'help' => '
                <dl>
                    ...
                    <dd>
                        Die Funktion "Automatische Synchronisierung per CronJob" &uuml;bermittelt alle 2 Stunden den aktuellen Versendet-Status zu real.de.<br/>
        ...
        'orderstatus.shipped' => array(
            ...
            'help' => 'Setzen Sie hier den Shop-Status, der auf real.de automatisch den Status "Versand best&auml;tigen" setzen soll.',
        ),
        'orderstatus.cancelled' => array(
            'label' => 'Bestellung stornieren mit',
            'help' => ' Setzen Sie hier den Shop-Status, der auf  real.de automatisch den Status "Bestellung stornieren" setzen soll. <br/><br/>
        ...
        'orderstatus.carrier' => array(
            'label' => 'Spediteur',
            'help' => 'Vorausgew&auml;hlter Spediteur beim Best&auml;tigen des Versandes nach real.de.',
        ),
        ...
        'preimport.start' => array(
            ...
            'help' => 'Startzeitpunkt, ab dem die Bestellungen erstmalig importiert werden sollen. Bitte beachten Sie, '
                . 'dass dies nicht beliebig weit in die Vergangenheit m&ouml;glich ist, da die Daten bei real.de '
		...
		'orderstatus.open' => array(
            ...
            'hint' => '',
            'help' => '
                Der Status, den eine von real.de neu eingegangene Bestellung im Shop automatisch bekommen soll.<br />
        ...
        'orderimport.shippingmethod' => array(
            ...
            'help' => 'Versandart, die allen real.de-Bestellungen zugeordnet wird. Standard: "real.de".<br><br>'
