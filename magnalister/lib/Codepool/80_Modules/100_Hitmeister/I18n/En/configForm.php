...
MLI18n::gi()->{'hitmeister_config_account__field__clientkey__help'} = 'Please find the API-Key in your real.de account. Therefore please login on real.de and select <b>real.de API<\\/b> in the bottom left menu under <b>Additional features<\\/b>.';
...
<br><br> <b>Hint:</b><br> 
If you acitvate the "Expert Settings" (can be found at the bottom left), you can define the shipping-time-matching. That means you assign shop-shipping-times to the real.de shipping-times. Every article gets a shipping time from the shop.';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematchingsub__label'} = 'shipping-time-matching';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematching__label'} = '';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematching__matching__titlesrc'} = 'real.de Shipping Time';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematching__matching__titledst'} = 'Shop Shipping Time';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematching.prefer__label'} = '';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematching.prefer__valuehint'} = 'Prefer shipping time matching';
...
To avoid overselling, you can activate \'Transfer shop inventory minus value from the right field\'.
                        <br/>
<strong>Example:</strong> Setting the value at 2 gives &#8594; Shop inventory: 10 &#8594; real.de inventory: 8<br/>
                        <br/>
...
MLI18n::gi()->{'hitmeister_config_price__field__price.signal__help'} = 'This textfield shows the decimal value that will appear in the item price on real.de.<br/><br/>
...
MLI18n::gi()->{'hitmeister_config_sync__field__stocksync.tomarketplace__help'} = '<dl>
            <dt>Automatic Synchronization via CronJob (recommended)</dt>
                    <dd>Current real.de stock will be synchronized with shop stock every 4 hours, beginning at 0.00am (with ***, depending on configuration).<br>Values will be transferred from the database, including the changes that occur through an ERP or similar.<br><br>
...
MLI18n::gi()->{'hitmeister_config_sync__field__stocksync.frommarketplace__help'} = 'If, for example, an item is purchased 3 times on real.de, the Shop inventory will be reduced by 3.<br /><br />
...
MLI18n::gi()->{'hitmeister_config_sync__field__inventorysync.price__help'} = '<p> Current real.de price  will be synchronized with shop stock every 4 hours, beginning at 0.00am (with ***, depending on configuration)<br>
...
MLI18n::gi()->{'hitmeister_config_orderimport__legend__orderstatus'} = 'Order Status Synchronization Between Shop and real.de';
...
MLI18n::gi()->{'hitmeister_config_orderimport__field__orderstatus.shipped__help'} = 'Select the shop status that will automatically set the real.de status to "confirm shipment".';
...
MLI18n::gi()->{'hitmeister_config_orderimport__field__orderstatus.carrier__help'} = 'Pre-Selected carrier during shipping confirmation to real.de';
...
MLI18n::gi()->{'hitmeister_config_orderimport__field__preimport.start__help'} = 'The date from which orders will start being imported. Please note that it is not possible to set this too far in the past, as the data only remains available on real.de for a few weeks.***';
...
MLI18n::gi()->{'hitmeister_config_orderimport__field__orderimport.shippingmethod__help'} = 'Shipping methods that will be assigned to all real.de orders. Standard: "real.de"<br><br>
