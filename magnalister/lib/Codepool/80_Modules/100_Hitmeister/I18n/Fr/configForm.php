...
MLI18n::gi()->{'hitmeister_config_account__field__clientkey__help'} = 'Vous trouverez les donnés d\'accès de l\'API dans votre compte Hitmeister. Connectez vous sur Hitmeister et cliquez sur <b>Hitmeister API<\\/b>, dans le menu en bas à gauche, puis sur <b>Zusatzfunktionen<\\/b>.';
...
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtime__help'} = 'Réglages par défaut pour le délais de livraison. Vous pouvez modifier cette valeur dans la préparation de l\'article. <br><br>
<b>Indication importante :</b><br> Si vous activez les réglages d\'experts (bouton en bas à gauche de la page), vous pouvez définir un classement automatique (matching) du délais de livraison, en d\'autres termes assigner les délais de livraison de votre boutique à ceux de Hitmeister, afin qu\'un délais de livraison soit attribut à chaque article sur Hitmeister en fonction des délais de livraison dans votre boutique.';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematchingsub__label'} = 'Matching du délais de livraison ';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematching__label'} = '';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematching__matching__titlesrc'} = 'délais de livraison sur Hitmeister';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematching__matching__titledst'} = 'Délais de livraison ';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematching.prefer__label'} = '';
MLI18n::gi()->{'hitmeister_config_prepare__field__shippingtimematching.prefer__valuehint'} = 'Privilegier le matching du délais de livraison ';
...
<br>
<b>Exemple :</b> Stock en boutique : 10 (articles) &rarr; valeur entrée: 2 (articles) &rarr; Stock alloué à Hitmeister : 8 (articles).<br>
<br>
<b>Remarque :</b> Si vous souhaitez cesser la vente sur Hitmeister, d’un article que vous avez encore en stock, mais que vous avez désactivé de votre boutique, procédez comme suit :
<ol>
      <li>
...
MLI18n::gi()->{'hitmeister_config_price__field__price.signal__help'} = 'Cette zone de texte sera utilisée dans les transmissions de données vers real.de, (prix après la virgule).<br><br>
...
MLI18n::gi()->{'hitmeister_config_sync__field__stocksync.tomarketplace__help'} = 'Utilisez la fonction “synchronisation automatique”, pour synchroniser votre stock Hitmeister et votre stock boutique. L’actualisation de base se fait toutes les quatre heures, - à moins que vous n’ayez définit d’autres paramètres - et commence à 00:00 heure. Si la synchronisation est activée, les données de votre base de données seront appliquées à Hitmeister.
...
Attention, toute importation provenant d’un client n’utilisant pas le tarif “flat” ou ne respectant pas le délai de 15 minute sera bloqué. <br>
 <br>
<b>Commande ou modification d’un article; l’état du stock Hitmeister  est comparé avec celui de votre boutique. </b> <br>
Chaque changement dans le stock de votre boutique, lors d’une commande ou de la modification d’un article, sera transmis à Hitmeister. <br>
...
<br>
<b>Commande ou modification d’un article; l’état du stock Hitmeister est modifié (différence)</b> <br>
Si par exemple, un article a été acheté deux fois en boutique, le stock Hitmeister sera réduit de 2 unités. <br>
Si vous modifiez la quantité d’un article dans votre boutique, sous la rubrique “Hitmeister” &rarr; “configuration” &rarr; “préparation d’article”, ce changement sera appliqué sur Hitmeister. <br>
<br>
...
MLI18n::gi()->{'hitmeister_config_sync__field__stocksync.frommarketplace__label'} = 'Variation du stock Hitmeister';
MLI18n::gi()->{'hitmeister_config_sync__field__stocksync.frommarketplace__help'} = 'Si cette fonction est activée le nombre de commandes effectués et payés sur Hitmeister sera soustrait de votre stock boutique.<br>
<br>
...
MLI18n::gi()->{'hitmeister_config_orderimport__field__orderstatus.sync__label'} = 'Synchronisation';
...
MLI18n::gi()->{'hitmeister_config_orderimport__field__orderstatus.shipped__help'} = 'Définissez ici le statut dans votre boutique, qui doit automatiquement attribuer le statut "Livraison confirmée" sur Hitmeister.';
MLI18n::gi()->{'hitmeister_config_orderimport__field__orderstatus.cancelled__label'} = 'Annuler la commande avec';
MLI18n::gi()->{'hitmeister_config_orderimport__field__orderstatus.cancelled__help'} = '        Définissez  ici le statut de la boutique, qui doit "annuler la commande" automatiquement sur Hitmeister. <br/><br/>
...
MLI18n::gi()->{'hitmeister_config_orderimport__field__orderimport.shippingmethod__help'} = 'Mode d\'expédition par défaut affectée à toutes les commandes Real.de. <br> <br> Ce paramètre est important pour la facturation et l\'émission du bon de livraison, ainsi que pour la prise en compte de la commande dans la boutique et dans le gestionnaire de stock.';
