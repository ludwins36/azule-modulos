...
class ML_Cdiscount_Helper_Model_Table_Cdiscount_ConfigData extends ML_Form_Helper_Model_Table_ConfigData_Abstract {
    ...
    public function shippingFeeStandardField(&$aField) {
        $aField['value'] = isset($aField['value']) ? str_replace(',', '.', trim($aField['value'])) : 0;
    ...
    public function shippingFeeExtraStandardField(&$aField) {
        $aField['value'] = isset($aField['value']) ? str_replace(',', '.', trim($aField['value'])) : 0;
        if ((string)((float)$aField['value']) != $aField['value']) {
            $this->addError($aField, MLI18n::gi()->get('cdiscount_config_checkin_badshippingcost'));
        } else {
    ...
    public function shippingFeeTrackedField(&$aField) {
        $aField['value'] = isset($aField['value']) ? str_replace(',', '.', trim($aField['value'])) : 0;
        if ((string)((float)$aField['value']) != $aField['value']) {
            $this->addError($aField, MLI18n::gi()->get('cdiscount_config_checkin_badshippingcost'));
        } else {
    ...
    public function shippingFeeExtraTrackedField(&$aField) {
        $aField['value'] = isset($aField['value']) ? str_replace(',', '.', trim($aField['value'])) : 0;
        if ((string)((float)$aField['value']) != $aField['value']) {
            $this->addError($aField, MLI18n::gi()->get('cdiscount_config_checkin_badshippingcost'));
        } else {
    ...
    public function shippingFeeRegisteredField(&$aField) {
        $aField['value'] = isset($aField['value']) ? str_replace(',', '.', trim($aField['value'])) : 0;
        if ((string)((float)$aField['value']) != $aField['value']) {
            $this->addError($aField, MLI18n::gi()->get('cdiscount_config_checkin_badshippingcost'));
        } else {
    ...
    public function shippingFeeExtraRegisteredField(&$aField) {
        $aField['value'] = isset($aField['value']) ? str_replace(',', '.', trim($aField['value'])) : 0;
        if ((string)((float)$aField['value']) != $aField['value']) {
            $this->addError($aField, MLI18n::gi()->get('cdiscount_config_checkin_badshippingcost'));
        } else {
