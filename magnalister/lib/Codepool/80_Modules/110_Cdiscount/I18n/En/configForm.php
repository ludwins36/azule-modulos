...
MLI18n::gi()->{'cdiscount_config_prepare__field__shipping_time_registered__help'} = 'Registered way of shipping.<br>
				            ...
				            shipping fees if the customer orders several products
				            in the same order.';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeestandard__label'} = 'Shipping fee (€)';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeeextrastandard__label'} = 'Additional shipping fee (€)';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeetracked__label'} = 'Shipping fee (€)';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeeextratracked__label'} = 'Additional shipping fee (€)';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeeregistered__label'} = 'Shipping fee (€)';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeeextraregistered__label'} = 'Additional shipping fee (€)';
...
MLI18n::gi()->{'cdiscount_config_orderimport__field__orderstatus.sync__label'} = 'Status synchronization';
...
MLI18n::gi()->{'cdiscount_config_orderimport__field__orderstatus.carrier.default__label'} = 'cdiscount_config_orderimport__field__orderstatus.carrier.default__label';
MLI18n::gi()->{'cdiscount_config_orderimport__field__orderstatus.carrier.default__help'} = 'cdiscount_config_orderimport__field__orderstatus.carrier.default__help';
