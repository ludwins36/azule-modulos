...
MLI18n::gi()->add('cdiscount_config_orderimport', array(
    ...
    'field' => array(
        ...
        'orderstatus.autoacceptance' => array(
            'label' => 'Auto acceptance of orders',
            'valuehint' => '(Recommended) Regardless you accept this field you will be able to reject order at any moment.Click help icon for more info.',
            'help' => 'If auto acceptance remain unchecked You will
