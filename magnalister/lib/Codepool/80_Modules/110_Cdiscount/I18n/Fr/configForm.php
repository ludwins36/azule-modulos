...
MLI18n::gi()->{'cdiscount_config_prepare__field__shipping_time_registered__help'} = 'Livraison recommandée<br>
      Les frais de port additionnels seront appliqués lorsqu\'un client commande plusieurs produits à la fois. ';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeestandard__label'} = 'Frais de port (€)';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeeextrastandard__label'} = 'Frais de port additionnel (€)';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeetracked__label'} = 'Frais de port (€)';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeeextratracked__label'} = 'Frais de port additionnel (€)';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeeregistered__label'} = 'Frais de port (€)';
MLI18n::gi()->{'cdiscount_config_prepare__field__shippingfeeextraregistered__label'} = 'Frais de port supplémentaires (€)';
...
MLI18n::gi()->{'cdiscount_config_orderimport__field__orderstatus.sync__label'} = 'Synchronisation du statut';
MLI18n::gi()->{'cdiscount_config_orderimport__field__orderstatus.sync__help'} = '            <dl>
                    <dt>Synchronisation automatique via CronJob (recommandée)</dt>
                    <dd>
                        La synchronisation automatique de la fonction via CronJob transmet toutes les 2 heures (à partir de 0:00 dans la nuit) le statut actuel des commandes (envoyées) sur Cdiscount.<br/>
                        Ainsi les valeurs venant de la base de données sont vérifiées et appliquées même si des changements, par exemple, dans la gestion des marchandises, sont seulement réalisés dans la base de données.<br/><br/>
...
MLI18n::gi()->{'cdiscount_config_orderimport__field__orderstatus.autoacceptance__valuehint'} = 'Si la fonction est activée vos commandes seront automatiquement acceptées sur Priceminister. Cliquez sur l\'icône d\'information pour en savoir plus.';
