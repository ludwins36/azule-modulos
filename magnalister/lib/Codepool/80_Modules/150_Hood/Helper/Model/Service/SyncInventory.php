...
require_once MLFilesystem::getOldLibPath('php/modules/hood/hoodFunctions.php');
...
class ML_Hood_Helper_Model_Service_SyncInventory extends MagnaCompatibleSyncInventory {
    ...
    protected function identifySKU() {
        ...
        $this->oProduct = MLProduct::factory()->getByMarketplaceSKU($this->cItem['SKU'], true);
        /* @var $oProduct ML_Shop_Model_Product_Abstract */
        if ($this->oProduct->exists()) {
            $this->cItem['pID'] = $this->oProduct->get('id');
        } else {
            $this->cItem['pID'] = 0;
        }
    }
