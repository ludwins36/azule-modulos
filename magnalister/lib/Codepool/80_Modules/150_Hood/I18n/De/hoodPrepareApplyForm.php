...
MLI18n::gi()->add('hood_prepare_apply_form', array(
    ...
    'field' => array(
        ...
        'starttime' => array(
            ...
            'hint' => 'Im Normalfall ist ein hood-Artikel sofort nach dem Hochladen aktiv. Aber wenn Sie dieses Feld füllen, erst ab Startzeit (<span style="color:red">kostenpflichtig</span>).',
        ),
         'noidentifierflag' => array(
            'label' => 'Sonderanfertigung',
            'hint' => 'Diese Einstellung erlaubt es, Artikel ohne EAN, ISBN, MPN oder Marke zu listen. <span style="color:red">Bitte nur in Ausnahmefällen verwenden. Ein generelles Setzen kann zur Sperrung des Google Shopping Accounts führen.</span>.',
        ),
...
MLI18n::gi()->hood_prepare_match_variations_no_selection = 'Bitte w&auml;hlen Sie eine Variantengruppe aus.';
...
MLI18n::gi()->hood_prepare_match_variations_saved = 'Erfolgreich gespeichert.';
MLI18n::gi()->hood_prepare_variations_saved = 'Es wurden alle ausgewählten Werte erfolgreich gematcht. Sie können nun Produkte mit den gematchten Attributen vorbereiten, oder mit dem Matching hier fortfahren.';
