...
MLI18n::gi()->{'hood_prepare_apply_form__field__pricecontainer__label'} = 'hood Price';
MLI18n::gi()->{'hood_prepare_apply_form__field__pricecontainer__hint'} = 'Price for hood';
...
MLI18n::gi()->{'hood_prepare_apply_form__field__starttime__hint'} = 'An item on hood is normally active immediately after uploading. Fill out this field to only make it available after the set start time (<span style="color:red">requires payment</span>).';
MLI18n::gi()->{'hood_prepare_apply_form__field__boldtitle__label'} = 'bold title';
MLI18n::gi()->{'hood_prepare_apply_form__field__backgroundcolor__label'} = 'Background color';
MLI18n::gi()->{'hood_prepare_apply_form__field__category__label'} = 'category';
MLI18n::gi()->{'hood_prepare_apply_form__field__homepage__label'} = 'homepage';
MLI18n::gi()->{'hood_prepare_apply_form__field__homepageimage__label'} = 'homepage image';
MLI18n::gi()->{'hood_prepare_apply_form__field__xxlimage__label'} = 'xx limage';
MLI18n::gi()->{'hood_prepare_apply_form__field__noads__label'} = 'NoAds';
