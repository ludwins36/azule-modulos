...
MLI18n::gi()->{'hood_config_account_title'} = 'Mes coordonnées';
...
MLI18n::gi()->{'hood_config_prepare__field__prepare.status__label'} = 'Statut du filtre';
MLI18n::gi()->{'hood_config_prepare__field__prepare.status__valuehint'} = 'Ne reprendre que les articles actifs';
...
MLI18n::gi()->{'hood_config_prepare__field__fixed.quantity__label'} = 'Nombre d\'unité';
...
';
MLI18n::gi()->{'hood_config_prepare__field__maxquantity__label'} = 'Nombre d\'unité maximale';
...
MLI18n::gi()->{'hood_config_prepare__field__chinese.quantity__label'} = 'Nombre d\'unité';
...
MLI18n::gi()->{'hood_config_orderimport__field__orderstatus.sync__label'} = 'Synchronisation du statut';
MLI18n::gi()->{'hood_config_orderimport__field__orderstatus.sync__hint'} = '';
MLI18n::gi()->{'hood_config_orderimport__field__orderstatus.sync__help'} = '<strong>Synchronisation automatique via CronJob (recommandée).</strong>
<p>La fonction synchronisation automatique via CronJob transmet toutes les heures et à partir de minuit, le statut actuel des commandes effectué sur hood.
...
MLI18n::gi()->{'hood_config_orderimport__field__mwstfallback__hint'} = 'Le taux d\'imposition lors d\'une importation de commandes d\'articles ne venant pas de la boutique sera alors calculé en %.';
