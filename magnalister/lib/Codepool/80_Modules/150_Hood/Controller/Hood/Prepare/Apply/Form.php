...
class ML_Hood_Controller_Hood_Prepare_Apply_Form extends ML_Form_Controller_Widget_Form_PrepareWithVariationMatchingAbstract {
    ...
    protected function conditionTypeField(&$aField) {
        ...
        $aField['values'] = MLModul::gi()->getPrepareConditionValues();

        if (isset($aField['values']['new'])) {
            if(is_array($aField['values']['new'])) {
                $aField['value'] = current($aField['values']['new']);
            } else {
                $aField['value'] = $aField['values']['new'];
            }
        }
    }
    ...
    protected function uskField(&$aField) {
        $aField['values'] = MLModul::gi()->getAgeValues();
    }
    ...
    protected function callGetCategoryDetails($sCategoryId) {
        ...
        MLMessage::gi()->addDebug($requestParams);
//MLMessage::gi()->addDebug('test');
