...
MLI18n::gi()->meinpaket_preimport_start_help = 'Startzeitpunkt, ab dem die Bestellungen erstmalig '
        ...
        . 'da die Daten bei Allyouneed höchstens einige Wochen lang vorliegen.';
...
MLI18n::gi()->add('meinpaket_config_prepare', array(
    ...
    'field' => array(
        ...
        'catmatch.mpshopcats' => array(
            ...
            'valuehint' => 'Kategorien dieses Shops als eigene Allyouneed-Kategorien verwenden'
        ),
        'shippingcost' => array (
            'label' => 'Versandkosten',
        ...
        'checkin.quantity' => array(
            ...
            'help' => 'Geben Sie hier an, wie viel Lagermenge eines Artikels auf dem Marktplatz verf&uuml;gbar sein soll.<br>
                ...
                <br>
                <strong>Beispiel:</strong> Wert auf "<i>2</i>" setzen. Ergibt &#8594; Shoplager: 10 &#8594; Allyouneed-Lager: 8<br>
                <br>
        ...
        'checkin.skipean' => array(
            ...
            'help' => 'Wenn die Checkbox aktiviert ist, wird eine am Artikel hinterlegte EAN zu Allyouneed '
                . '&uuml;bertragen.<br><br> Bitte beachten Sie, dass Allyouneed dann versucht die EAN an '
                . 'bestehende Artikel zu matchen. Dies kann dazu f&uuml;hren, dass bei abweichenden Informationen der '
                . 'Artikel von Allyouneed zur&uuml;ckgewiesen wird. Die EAN ist KEIN Pflichtfeld bei Allyouneed.',
        ),
        ...
        'checkin.taxmatching' => array(
            ...
            'help' => 'Shop-eigene Steuerklassen denen von Allyouneed zuordnen.',
            'matching' => array(
                'titlesrc' => '',
                'titledst' => '',
                'labelsdst' => array(
        ...
        'checkin.shortdesc' => array(
            ...
            'help' => 'Die Kurzbeschreibung ist ein Pflichfeld bei Allyouneed. Standardm&auml;&szlig;ig wird hier '
        ...
        'checkin.longdesc' => array(
            ...
            'help' => 'Die Langbeschreibung ist kein Pflichfeld bei Allyouneed. Standardm&auml;&szlig;ig wird diese '
                . "nicht &uuml;bertragen.Sie k&ouml;nnen jedoch auch die Langbeschreibung aus einem anderen "
                . 'Datenfeld verwenden, und diese an Allyouneed &uuml;bertragen.<br>',
        ),
        'imagesize' => array(
...
MLI18n::gi()->add('meinpaket_config_price', array(
    ...
    'field' => array(
        ...
        'price.signal' => array(
            ...
            'help' => '
                Dieses Textfeld wird beim &Uuml;bermitteln der Daten zu Allyouneed als Nachkommastelle an Ihrem Preis &uuml;bernommen.<br><br>
...
MLI18n::gi()->add('meinpaket_config_orderimport', array(
    'legend' => array(
        ...
        'mwst' => 'Mehrwertsteuer',
        'orderstatus' => 'Synchronisation des Bestell-Status vom Shop zu Allyouneed',
    ),
    'field' => array(
        'importactive' => array(
        ...
        'preimport.start' => array(
            ...
            'help' => 'Startzeitpunkt, ab dem die Bestellungen erstmalig importiert werden sollen. Bitte beachten Sie, 
                dass dies nicht beliebig weit in die Vergangenheit möglich ist, da die Daten bei Allyouneed höchstens 
        ...
        'orderstatus.open' => array(
            ...
            'help' => '
                Der Status, den eine von Allyouneed neu eingegangene Bestellung im Shop automatisch bekommen soll.<br>
        ...
        'orderimport.shippingmethod' => array(
            ...
            'help' => 'Versandart, die allen Allyouneed-Bestellungen zugeordnet wird. Standard: "marketplace".<br><br>'
        ...
        'orderimport.paymentmethod' => array(
            ...
            'help' => 'Zahlart, die allen Allyouneed-Bestellungen zugeordnet wird. Standard: "marketplace".<br><br>'
                . 'Diese Einstellung ist wichtig f&uuml;r den Rechnungs- und Lieferscheindruck und f&uuml;r '
                . 'die nachtr&amul;gliche Bearbeitung der Bestellung im Shop sowie einige Warenwirtschaften.',
        ),
        'mwst.fallback' => array(
        ...
        'mwst.shipping' => array(
            ...
            'help' => 'Allyouneed &uuml;bermittelt nicht den Steuersatz der Versandkosten, sondern nur die 
            ...
            'help' => '
                <dl>
                    ...
                    <dd>
                        ...
                        den aktuellen Versendet-Status zu Allyouneed.<br>
        ...
        'orderstatus.shipped' => array(
            ...
            'help' => 'Setzen Sie hier den Shop-Status, der auf Allyouneed automatisch den Status "Versand best&auml;tigen" setzen soll.',
        ),
        'orderstatus.canceled.customerrequest' => array(
            'label' => 'Stornieren (auf Kundenwunsch) mit',
            'help' => 'Allyouneed verlangt die &Uuml;bermittlung eines Grundes bei einer Stornierung.<br><br>
                Setzen Sie hier den Shop-Status, der auf Allyouneed.de dem Status "Stornieren auf Kundenwunsch (Customer Request)" 
                setzen soll.<br><br>
        ...
        'orderstatus.canceled.outofstock' => array(
            ...
            'help' => 'Allyouneed verlangt die &Uuml;bermittlung eines Grundes bei einer Stornierung.<br><br>
                Setzen Sie hier den Shop-Status, der auf Allyouneed.de automatisch den Status "Stornieren, da Ware 
        ...
        'orderstatus.canceled.dealerrequest' => array(
            ...
            'help' => 'Allyouneed verlangt die &Uuml;bermittlung eines Grundes bei einer Stornierung.<br><br>
                Setzen Sie hier den Shop-Status, der auf Allyouneed.de automatisch den Status "Storniert durch 
...
MLI18n::gi()->add('meinpaket_config_sync', array(
    ...
    'field' => array(
            ...
            'help' => '
                <dl>
                    ...
                    <dd>Die Funktion "Automatische Synchronisierung" gleicht alle 4 Stunden (beginnt um 0:00 Uhr nachts)
                        den aktuellen Allyouneed-Lagerbestand an der Shop-Lagerbestand an 
        ...
        'stocksync.frommarketplace' => array(
            'label' => 'Lagerver&auml;nderung Allyouneed',
            'help' => '
                Wenn z. B. bei Allyouneed ein Artikel 3 mal gekauft wurde, wird der Lagerbestand im Shop um 3 reduziert.<br><br>
        ...
        'inventorysync.price' => array(
            ...
            'help' => '
                <p>
                    ...
                    den aktuellen Shop-Preis auf Ihren Allyouneed-Preis an.<br>
