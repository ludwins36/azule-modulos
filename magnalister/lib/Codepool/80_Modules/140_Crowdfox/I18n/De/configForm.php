    ...
    'field' => array(
        'stocksync.tomarketplace' => array(
            ...
            'help' => '
                <p>
                    ...
                    den aktuellen Crowdfox-Lagerbestand an der Shop-Lagerbestand an (je nach Konfiguration ggf. mit Abzug).<br>
        ...
        'inventorysync.price' => array(
            ...
            'help' => '
                <p>
                    Die Funktion "Automatische Synchronisierung" gleicht alle 4 Stunden (beginnt um 0:00 Uhr nachts)
                    den aktuellen Shop-Preis auf Ihren Crowdfox-Preis an.<br>
                    Dabei werden die Werte aus der Datenbank gepr&uuml;ft und &uuml;bernommen, auch wenn die &Auml;nderungen durch z.B. 
        ...
        'orderstatus.sync' => array(
            ...
            'help' => '
                <dl>
                    ...
                    <dd>
                        Die Funktion "Automatische Synchronisierung per CronJob" &uuml;bermittelt alle 2 Stunden den aktuellen Versendet-Status zu Crowdfox.<br/>
