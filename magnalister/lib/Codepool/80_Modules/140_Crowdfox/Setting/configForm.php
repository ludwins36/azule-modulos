...
MLSetting::gi()->add('crowdfox_config_account', array(
    'tabident' => array(
        'legend' => array(
...
MLSetting::gi()->add('crowdfox_config_prepare', array(
    'prepare' => array(
        'fields' => array(
            array(
                'name' => 'prepare.status',
...
MLSetting::gi()->add('crowdfox_config_price', array(
    'price' => array(
        'fields' => array(
            array(
                'name' => 'price',
...
MLSetting::gi()->add('crowdfox_config_sync', array(
    'sync' => array(
        'fields' => array(
            array(
...
MLSetting::gi()->add('crowdfox_config_orderimport', array(
    'importactive' => array(
        'fields' => array(
            array(
                'name' => 'importactive',
...
MLSetting::gi()->add('crowdfox_config_producttemplate', array(
    'product' => array(
        'fields' => array(
            array(
                'name' => 'template.name',
            ...
            array(
                ...
                'default' => '{#i18n:crowdfox_config_producttemplate_content#}',
                'resetdefault' => '{#i18n:crowdfox_config_producttemplate_content#}',
                'type' => 'wysiwyg',
            ),
        ),
    ),
...
MLSetting::gi()->add('crowdfox_config_emailtemplate', array(
    'mail' => array(
        'fields' => array(
            array(
                'name' => 'mail.send',
            ...
            array(
                ...
                'type' => 'string',
                'default' => '{#i18n:crowdfox_config_account_emailtemplate_sender#}',
            ),
            array(
                'name' => 'mail.originator.adress',
                'type' => 'string',
                'default' => '{#i18n:crowdfox_config_account_emailtemplate_sender_email#}',
            ),
            array(
                'name' => 'mail.subject',
                'type' => 'string',
                'default' => '{#i18n:crowdfox_config_account_emailtemplate_subject#}',
            ),
            array(
                'name' => 'mail.content',
                'type' => 'configMailContentContainer',
                'default' => '{#i18n:crowdfox_config_account_emailtemplate_content#}',
            ),
            array(
                'name' => 'mail.copy',
                'type' => 'radio',
