...
class ML_Tradoria_Controller_Tradoria_Prepare_Apply extends ML_Productlist_Controller_Widget_ProductList_Selection {

    protected $aParameters = array('controller');

    public static function getTabTitle() {
        return MLI18n::gi()->get('tradoria_prepare_apply');
    }
