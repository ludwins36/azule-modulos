...
MLI18n::gi()->{'tradoria_config_prepare__field__checkin.taxmatching__matching__labelsdst__Standard'} = 'Standard';
MLI18n::gi()->{'tradoria_config_prepare__field__checkin.taxmatching__matching__labelsdst__Reduced'} = 'Reduced';
MLI18n::gi()->{'tradoria_config_prepare__field__checkin.taxmatching__matching__labelsdst__Free'} = 'Tax-Free';
...
MLI18n::gi()->{'tradoria_config_orderimport__field__orderstatus.carrier.default__help'} = 'Pre-selected carrier on confirmation of shipping to Rakuten';
...
MLI18n::gi()->{'tradoria_config_orderimport__field__mwst.fallback__help'} = 'If an item is not entered in the web-shop, magnalister uses the VAT from here since marketplaces give no details to VAT within the order import.<br />
<br />
...
MLI18n::gi()->{'tradoria_config_orderimport__field__orderimport.shippingmethod__label'} = 'Shipping Service of the Orders';
MLI18n::gi()->{'tradoria_config_orderimport__field__orderimport.shippingmethod__help'} = 'Shipping methods that will be assigned to all Rakuten orders. Standard: "Marketplace"<br><br>
...
MLI18n::gi()->{'tradoria_config_emailtemplate__field__mail.originator.adress__label'} = 'Sender E-Mail Address';
MLI18n::gi()->{'tradoria_config_emailtemplate__field__mail.subject__label'} = 'Subject';
MLI18n::gi()->{'tradoria_config_emailtemplate__field__mail.content__label'} = 'E-Mail Content';
