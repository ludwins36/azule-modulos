...
MLI18n::gi()->{'ricardo_config_account_title'} = 'Mes coordonnées';
...
MLI18n::gi()->{'ricardo_config_prepare_maxrelistcount_sellout'} = 'ricardo_config_prepare_maxrelistcount_sellout';
...
MLI18n::gi()->{'ricardo_label_sync_quantity'} = 'Activer la réduction et l\'augmentation du stock sur Ricardo.ch';
...
MLI18n::gi()->{'ricardo_label_sync_price'} = 'Activer la hausse de prix et la  réduction de prix sur Ricardo.ch';
...
MLI18n::gi()->{'ricardo_config_error_price_signal'} = 'Les prix sur ricardo.ch doivent être indiqués en francs suisses. Veuillez les  adapter à 2 décimals près, pour qu\'ils finissent, soit par 0 (ex. 12,40), soit par 5 (ex. 12,45). Le plus petit montant autorisé est de 5 centimes (0,05 CHF). D\'autres informations en cliquant sur l\'icône d\'info.';
...
MLI18n::gi()->{'ricardo_config_account__field__token__label'} = 'Jeton (Token)';
MLI18n::gi()->{'ricardo_config_account__field__token__help'} = 'Le jeton (Token) est obligatoire, pour pouvoir utiliser magnalister, pour traiter et gérer vos articles sur ricardo.ch. Il est renouvelable tous les deux ans.<br>
...
MLI18n::gi()->{'ricardo_config_prepare__field__checkin.showlimitationwarning__help'} = 'Veuillez noter que ricardo.ch fixe en principe une limite de 100 annonces publiées simultanément par vendeur. Cette limite peut être adaptée au cas par cas, à la demande du vendeur. Avant de charger votre produit, assurez-vous bien de ne dépassez pas cette limite et vérifiez le log d\'erreurs au moins 30 minutes après le chargement.
<br><br>
...
<b>Remarque :Ricardo.ch impose une limite de disponibilité. Veillez à ce que le niveau de stock par article mis en vente sur la plateforme ricardo.ch n\'excède pas 999 pièces.</b> <br>
...
<br>
<i>{#setting:sSyncOrderStatusUrl#}</i></p>
...
Si la fonction est activée, les commandes seront automatiquement importées toutes les heures.<br><br>
Vous pouvez régler vous-même la durée de l\'importation automatique des commandes en cliquant sur<br>
"magnalister Admin" → "Configuration globale" → "Importation des commandes".<br><br>
...
En outre, vous pouvez également déclencher l\'importation des commandes (dès le "tarif Flat" - au maximum toutes les 15 minutes) via
