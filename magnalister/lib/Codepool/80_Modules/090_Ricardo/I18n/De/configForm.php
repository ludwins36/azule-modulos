...
MLI18n::gi()->add('ricardo_config_account', array(
    ...
    'field' => array(
        ...
        'token' => array(
            'label' => 'ricardo.ch-Token',
            'help' => 'Um einen neuen ricardo.ch-Token zu beantragen, klicken Sie bitte auf den Button.<br>
                        Sollte kein Fenster zu ricardo.ch aufgehen, wenn Sie auf den Button klicken, haben Sie einen Pop-Up Blocker aktiv.<br><br>
                        Der Token ist notwendig, um &uuml;ber elektronische	Schnittstellen wie den magnalister Artikel auf ricardo.ch einzustellen und zu verwalten.<br>
                        Folgen Sie von da an den Anweisungen auf der ricardo.ch Seite, um den Token zu beantragen und Ihren Online-Shop &uuml;ber magnalister mit ricardo.ch zu verbinden.',
        ),
        'apilang' => array(
...
MLI18n::gi()->add('ricardo_config_prepare', array(
    ...
    'field' => array(
        ...
        'checkin.showlimitationwarning' => array(
            ...
            'help' => 'Bitte beachten Sie, dass Sie nicht mehr als 100 Angebote gleichzeitig auf ricardo.ch veröffentlichen können. Darüber hinaus darf der Lagerbestand für jeden veröffentlichten Artikel nicht größer als 999 Stück sein.
<br><br>
        ...
        'stocksync.tomarketplace' => array(
            ...
            'help' => '
                <p>
                    ...
                    <b>Hinweise:</b><ul style="color:black;list-style:disc;padding-left: 1em">
						<li>ricardo.ch l&auml;sst grunds&auml;tzlich keine Lagererh&ouml;hung f&uuml;r laufende Angebote zu.
Um dennoch eine automatische Anpassung m&ouml;glich zu machen, beendet magnalister im Hintergrund ein laufendes Angebot und stellt es mit dem erh&ouml;hten Lagerbestand neu ein, sobald diese Funktion aktiviert wird.<br><br>
<b>Auf ricardo.ch gilt ein Verfügbarkeitslimit. Bitte achten Sie darauf, dass der Lagerbestand pro Artikel, der auf dem ricardo.ch Marktplatz angeboten werden soll, nicht über 999 Stück liegt.</b><br><br>
W&auml;hlen Sie "nur Reduzierung", wenn Sie automatische Neueinstellungen vermeiden wollen.<br><br>
</li>
						<li>Die Einstellungen unter "Konfiguration" &rarr; "Einstellvorgang" &rarr; "St&uuml;ckzahl Lagerbestand"
                    werden ber&uuml;cksichtigt.</li></ul>
				</p>
            ',
        ),
        ...
        'inventorysync.price' => array(
            ...
            'help' => '
                <p>
                    ...
                    <br><br>
                    <b>Hinweise:</b><ul style="color:black;list-style:disc;padding-left: 1em">
						<li>ricardo.ch l&auml;sst grunds&auml;tzlich keine Preiserh&ouml;hung f&uuml;r laufende Angebote zu.
...
W&auml;hlen Sie "nur Reduzierung", wenn Sie automatische Neueinstellungen vermeiden wollen.<br><br>
						...
						<li>Die Einstellungen unter "Konfiguration" &rarr; "Preisberechnung" werden ber&uuml;cksichtigt.</li></ul>
                </p>
            ',
        ),
    ),
