    ...
    'field' => array(
        'stocksync.tomarketplace' => array(
            ...
            'help' => '
                <p>
                    ...
                    den aktuellen PriceMinister-Lagerbestand an der Shop-Lagerbestand an (je nach Konfiguration ggf. mit Abzug).<br>
        ...
        'inventorysync.price' => array(
            ...
            'help' => '
                <p>
                    Die Funktion "Automatische Synchronisierung" gleicht alle 4 Stunden (beginnt um 0:00 Uhr nachts)
                    den aktuellen Shop-Preis auf Ihren PriceMinister-Preis an.<br>
                    Dabei werden die Werte aus der Datenbank gepr&uuml;ft und &uuml;bernommen, auch wenn die &Auml;nderungen durch z.B. 
...
MLI18n::gi()->add('priceminister_config_orderimport', array(
    ...
    'field' => array(
        'orderstatus.sync' => array(
            ...
            'help' => '
                <dl>
                    ...
                    <dd>
                        Die Funktion "Automatische Synchronisierung per CronJob" &uuml;bermittelt alle 2 Stunden den aktuellen Versendet-Status zu PriceMinister.<br/>
        ...
        'orderstatus.autoacceptance' => array(
            ...
            'help' => 'Da PriceMinisters API die Versandkosten f&uuml;r nicht-best&auml;tigte Bestellungen nicht bereitstellt, werden Bestellungen ohne Versandkosten in Ihrem Web-Shop angelegt, wenn die Funktion deaktiviert ist. Wir empfehlen daher die Automatische Bestellbest&auml;tigung zu aktivieren.',
        ),
        'orderstatus.accepted' => array(
            'label' => 'Accept order with',
            'hint' => '<span style="color:red;">Please read info for more explanation.</span>',
            'help' => 'Before confirming shipment please select default value for accepting order on PriceMinister.<br/><br/><b>IMPORTANT:</b><br/><br/> 
        ...
        'orderstatus.refused' => array(
            ...
            'hint' => '<span style="color:red;">Please read info for more explanation.</span>',
            'help' => 'Please select default value for refusing order on PriceMinister after receiving one in your shop.<br/><br/><b>IMPORTANT:</b><br/><br/> 
