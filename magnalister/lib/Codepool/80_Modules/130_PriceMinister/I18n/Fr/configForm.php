...
MLI18n::gi()->{'priceminister_config_account_title'} = 'Mes coordonnées';
...
MLI18n::gi()->{'priceminister_config_account__field__password__label'} = 'Mot de passe';
...
MLI18n::gi()->{'priceminister_config_orderimport__field__orderstatus.sync__label'} = 'Synchronisation du statut';
MLI18n::gi()->{'priceminister_config_orderimport__field__orderstatus.sync__help'} = '            <dl>
                    ...
                    <dd>
                        La synchronisation automatique de la fonction via CronJob transmet toutes les 2 heures (à partir de 0:00 dans la nuit) le statut actuel des commandes (envoyées) sur Priceminister.<br/>
...
MLI18n::gi()->{'priceminister_config_orderimport__field__orderimport.shippingmethod__label'} = 'Envoi de la commande';
