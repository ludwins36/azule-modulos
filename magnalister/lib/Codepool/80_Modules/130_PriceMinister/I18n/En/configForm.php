...
MLI18n::gi()->{'priceminister_config_account__field__password__label'} = 'Password';
...
MLI18n::gi()->{'priceminister_config_orderimport__field__orderstatus.sync__label'} = 'Status Synchronization';
MLI18n::gi()->{'priceminister_config_orderimport__field__orderstatus.sync__help'} = '<dl>
                    <dt>Automatic Synchronization via CronJob (recommended)</dt>
                    <dd>
                        The function &apos;Automatic Synchronization with CronJob&apos; transfers the current Sent Status to PriceMinister every 2 hours.<br/>
...
Additionally you can activate the Order Status Comparison through CronJob (flat tariff - maximum 4 times per hour) with the link: <br/><br/>
