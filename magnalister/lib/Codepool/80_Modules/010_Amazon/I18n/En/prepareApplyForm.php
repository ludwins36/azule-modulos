...
MLI18n::gi()->{'amazon_prepare_apply_form__field__images__hint'} = 'Up to 9 Product Pictures';
...
MLI18n::gi()->{'amazon_prepare_apply_form__field__bulletpoints__hint'} = 'Key features of the product (e.g. "gold plated taps")<br /><br />This data are traken from the {#i18n:sAmazon_product_bolletpoints_fieldName#}, and must be comma separated.<br />Up to 500 characters each.';
...
MLI18n::gi()->{'amazon_prepare_apply_form__field__keywords__hint'} = 'Used in search.<br /><br />This data are taken from the Meta Keywords, and must be comma separated.<br />Up to 50-1000 characters allowed, depending on the Amazon Category.';
...
MLI18n::gi()->{'amazon_prepare_apply_form__field__b2bactive__label'} = 'Actibate Amazon Business';
...
MLI18n::gi()->{'amazon_prepare_match_variations_no_selection'} = 'Please select a variation-group';
...
MLI18n::gi()->{'amazon_prepare_match_variations_saved'} = 'Saved succesfully.';
MLI18n::gi()->{'amazon_prepare_variations_saved'} = 'All selected values were matched successfully. You can now prepare the products with the matched attributes or continue matching here.';
