...
MLI18n::gi()->{'amazon_config_account_shippinglabel'} = 'Shipping Costs';
...
MLI18n::gi()->{'amazon_config_tier_error'} = 'Configuration for B2B Quantity Discount Tier %s is not valid!';
...
MLI18n::gi()->{'amazon_config_prepare__field__shipping.template__label'} = 'Seller shipping groups';
...
If a seller generates an offer out of his products, he has to choose one of his shipping condition groups fort he product. That shipping procedure of this group is then used to show the shipping option for the product on the website.';
MLI18n::gi()->{'amazon_config_prepare__field__shipping.template.name__label'} = 'Seller shipping group label';
MLI18n::gi()->{'amazon_config_prepare__field__b2bactive__label'} = 'Activate Business';
...
If you are already an Amazon merchant you can therefore login to your Seller Central Account and activate the Business Seller Service. A "Professional Seller Account" is required for that. (Can be upgraded within your Seller Account).<br />
...
MLI18n::gi()->{'amazon_config_orderimport__field__orderstatus.carrier.default__help'} = 'Pre-selected carrier with confirmation of distribution to amazon.';
...
MLI18n::gi()->{'amazon_config_shippinglabel__legend__shippingaddresses'} = 'shipping adresses';
...
MLI18n::gi()->{'amazon_config_shippinglabel__field__shippinglabel.address__label'} = 'shipping adress';
...
MLI18n::gi()->{'amazon_config_shippinglabel__field__shippinglabel.address.country__label'} = 'Land';
MLI18n::gi()->{'amazon_config_shippinglabel__field__shippinglabel.address.phone__label'} = 'Phone number';
MLI18n::gi()->{'amazon_config_shippinglabel__field__shippinglabel.address.email__label'} = 'E-Mail-adresses';
