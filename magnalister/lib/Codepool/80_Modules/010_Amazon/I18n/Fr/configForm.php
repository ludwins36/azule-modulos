...
MLI18n::gi()->{'amazon_config_general_mwstoken_help'} = 'Pour pouvoir transmettre vos données, Amazon demande une authentification. 
...
MLI18n::gi()->{'amazon_config_tier_error'} = 'Amazon Business (B2B): votre configuration n\'est pas correcte!';
...
MLI18n::gi()->{'amazon_config_prepare__field__b2bactive__label'} = 'Activer l\'option Business';
...
MLI18n::gi()->{'amazon_config_prepare__field__b2bdiscounttier1__label'} = 'Prix Planchet 1';
MLI18n::gi()->{'amazon_config_prepare__field__b2bdiscounttier2__label'} = 'Prix Planchet 2';
MLI18n::gi()->{'amazon_config_prepare__field__b2bdiscounttier3__label'} = 'Prix Planchet 3';
MLI18n::gi()->{'amazon_config_prepare__field__b2bdiscounttier4__label'} = 'Prix Planchet 4';
MLI18n::gi()->{'amazon_config_prepare__field__b2bdiscounttier5__label'} = 'Prix Planchet 5';
...
MLI18n::gi()->{'amazon_config_orderimport__field__orderimport.amazonpromotionsdiscount__help'} = '<p>magnalister importe les rabais d\'Amazon Promotions en tant que produits indépendants dans votre boutique en ligne. Un produit est créé dans la commande importée pour chaque produit et remise d\'expédition.</p>
                           <p>Dans cette option de paramétrage, vous pouvez définir vos propres numéros de poste pour ces remises promotionnelles.</p>';
MLI18n::gi()->{'amazon_config_orderimport__field__orderimport.amazonpromotionsdiscount.products_sku__label'} = 'Remise d\'article - Numéro d\'article';
MLI18n::gi()->{'amazon_config_orderimport__field__orderimport.amazonpromotionsdiscount.shipping_sku__label'} = 'Remise d\'expédition - Numéro d\'article';
