...
MLI18n::gi()->{'ebay_prepare_apply_form__field__paymentsellerprofile__label'} = 'Frame conditions: Payment methods';
...
MLI18n::gi()->{'ebay_prepare_apply_form__field__paymentmethods__help'} = 'Presetting for payment mehtods (Multi-select with CTRL+click). Selection specifications from eBay.';
...
MLI18n::gi()->{'ebay_prepare_apply_form__field__shippingsellerprofile__label'} = 'Frame conditions: Shipment';
...
This field is not editable since you are using the eBay frame-conditions. Please use the selection-field
<b>frame condition: shipping</b> to determine the profile for shipping conditions.';
...
MLI18n::gi()->{'ebay_prepare_variations__legend__variations'} = 'ebay_prepare_variations__legend__variations';
...
MLI18n::gi()->{'ebay_prepare_match_variations_no_selection'} = 'ebay_prepare_match_variations_no_selection';
...
MLI18n::gi()->{'ebay_prepare_match_variations_saved'} = 'Products have been prepared successfully and can be uploaded.';
MLI18n::gi()->{'ebay_prepare_variations_saved'} = 'ebay_prepare_variations_saved';
