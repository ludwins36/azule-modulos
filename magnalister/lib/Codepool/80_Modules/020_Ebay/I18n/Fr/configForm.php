...
MLI18n::gi()->{'ebay_config_account_prepare'} = 'Préparation d\'article';
...
MLI18n::gi()->{'ebay_config_prepare__field__useprefilledinfo__help'} = 'Si la fonction est activée les informations détaillées sur l\'article du catalogue eBay (si il en a) seront affiché sur la page de votre offre. Pour que cette fonction prennent effet les codes EAN doivent être indiqués pour chaque article.';
...
MLI18n::gi()->{'ebay_config_prepare__field__fixed.quantity__label'} = 'Nombre d\'unité';
...
';
MLI18n::gi()->{'ebay_config_prepare__field__maxquantity__label'} = 'Nombre d\'unité maximale';
...
MLI18n::gi()->{'ebay_config_prepare__field__chinese.quantity__label'} = 'Nombre d\'unité';
...
MLI18n::gi()->{'ebay_config_orderimport__field__orderstatus.paid__help'} = 'Le statut attribué aux commandes dans votre boutique lorsqu\'elles sont payées sur eBay.<br/>
...
MLI18n::gi()->{'ebay_config_producttemplate__field__template.mobile.content__hint2'} = '<b>Indication</b>:<br />L’utilisation des tags HTLM n’est autorisée, que pour la mise en forme des listes et les retours à la ligne, aucune autre ne sera prise en compte.';
