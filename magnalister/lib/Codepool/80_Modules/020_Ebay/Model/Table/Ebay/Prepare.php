...
class ML_Ebay_Model_Table_Ebay_Prepare extends ML_Database_Model_Table_Prepare_Abstract {
    ...
    protected $aFields = array (
        ...
        'paymentsellerprofile'                => array (
            'Type' => 'varchar(16)', 'Null' => 'YES', 'Default' => NULL, 'Extra' => '', 'Comment'=>''
        ),
        ...
        'ErrorCode'     => array (
            'Type' => 'VARCHAR(10)', 'Null' => 'YES', 'Default' => '', 'Extra' => '', 'Comment'=>''
        ),
        'productRequired'     => array (
            'Type' => "ENUM('false', 'true')", 'Null' => 'YES', 'Default' => 'false', 'Extra' => '', 'Comment'=>''
        ),
        'ePID'     => array (
            'Type' => 'VARCHAR(43)', 'Null' => 'YES', 'Default' => '', 'Extra' => '', 'Comment'=>''
        ),
        'Transferred'  => array (
            'Type' => 'tinyint(1)', 'Null' => 'NO', 'Default' => '0', 'Extra' => '', 'Comment'=>''
        ),
