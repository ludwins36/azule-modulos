...
MLI18n::gi()->{'check24_config_account_title'} = 'Mes coordonnées';
...
';
MLI18n::gi()->{'check24_config_account__legend__account'} = 'Mes coordonnées';
...
MLI18n::gi()->{'check24_config_account__field__mpusername__help'} = 'check24_config_account__field__mpusername__help';
MLI18n::gi()->{'check24_config_account__field__mppassword__label'} = 'Mot de passe';
MLI18n::gi()->{'check24_config_account__field__port__label'} = 'Port';
...
MLI18n::gi()->{'check24_config_orderimport__field__orderstatus.sync__label'} = 'Synchronisation du statut';
MLI18n::gi()->{'check24_config_orderimport__field__orderstatus.sync__hint'} = '';
MLI18n::gi()->{'check24_config_orderimport__field__orderstatus.sync__help'} = '            <dl>
                    <dt>Synchronisation automatique via CronJob (recommandée)</dt>
                    <dd>
                        La synchronisation automatique de la fonction via CronJob transmet toutes les 2 heures (à partir de 0:00 dans la nuit) le statut actuel des commandes (envoyées) sur Check24.<br/>
                        Ainsi les valeurs venant de la base de données sont vérifiées et appliquées même si des changements, par exemple, dans la gestion des marchandises, sont seulement réalisés dans la base de données.<br/><br/>
...
MLI18n::gi()->{'check24_config_orderimport__field__mwst.fallback__hint'} = 'Le taux d\'imposition lors d\'une importation de commandes d\'articles ne venant pas de la boutique sera alors calculé en %.';
...
MLI18n::gi()->{'check24_config_orderimport__field__customergroup__label'} = 'Groupe client';
