...
MLI18n::gi()->{'check24_config_account__field__mppassword__label'} = 'Password';
...
MLI18n::gi()->{'check24_config_prepare__field__checkin.status__hint'} = 'only take active article';
