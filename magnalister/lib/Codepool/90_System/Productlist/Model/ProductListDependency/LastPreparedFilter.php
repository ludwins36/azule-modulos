    ...
    protected function getFilterValues() {
        if ($this->aFilterValues === null) {
            ...
            $sSql = "
                ...
                AND ".MLDatabase::getPrepareTableInstance()->getMarketplaceIdFieldName()."='".MLModul::gi()->getMarketPlaceId()."'
    ...
    public function getMasterIdents() {
        ...
        if ($sValue !== 'all' && in_array($sValue, array_keys($this->getFilterValues()))) {
            ...
            $sSql = "
                ...
                WHERE prepare.".MLDatabase::getPrepareTableInstance()->getPreparedTimestampFieldName()."='".MLDatabase::getDbInstance()->escape($sValue)."'
