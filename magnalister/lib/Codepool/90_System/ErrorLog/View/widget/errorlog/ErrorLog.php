                        ...
                        foreach ($this->getFields() as $aField) {
                            if ($aField['Field'] != null) {
                                ...
                                if(method_exists($this, 'get'.  ucfirst($aField['Field']))){
                                    ...
                                    if (strpos(htmlentities(html_entity_decode($oErrorlog->get($aField['Field']), null, 'UTF-8'), null, 'UTF-8'), '&lt;div') !== false) {
                                        echo html_entity_decode($oErrorlog->get($aField['Field']), null, 'UTF-8');
                                    } else {
