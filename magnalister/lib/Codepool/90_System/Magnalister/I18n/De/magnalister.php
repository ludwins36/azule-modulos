...
/* real.de */
MLI18n::gi()->ML_HITMEISTER_SAME_PRODUCT_THERE = 'Dieser Artikel bei real.de';
MLI18n::gi()->ML_HITMEISTER_LABEL_HITMEISTER_PRICE = 'Mein real.de Preis';
MLI18n::gi()->ML_HITMEISTER_LABEL_ORDER_ID = 'real.de-Bestellnummer';
...
MLI18n::gi()->ML_HITMEISTER_TEXT_NO_MATCHED_PRODUCTS = 'Es sind noch keine Produkte f&uuml;r real.de vorbereitet worden. Bevor Sie Produkte hier hochladen k&ouml;nnen, m&uuml;ssen Sie diese unter dem Reiter "Produkte vorbereiten" bearbeiten.<br>
        Falls Sie an der Stelle Artikel vermissen sollten, die Sie bereits vorbereitet haben, &uuml;berpr&uuml;fen Sie, ob diese ggf. auf Inaktiv gesetzt sind und Sie die Konfiguration entsprechend eingestellt haben.';
MLI18n::gi()->ML_HITMEISTER_LABEL_LAST_REPORT = 'Letzter Bericht von real.de';
...
MLI18n::gi()->ML_RICARDO_TEXT_TOKEN_NOT_AVAILABLE_YET = 'Es ist noch kein Token hinterlegt worden, bzw. der Token konnte
            nicht erfolgreich gespeichert werden. Bitte beantragen Sie einen neuen Token.';
...
MLI18n::gi()->ML_MESSAGE_BEFORE_SYNC_ORDERSTATUS_TEXT = 'Es werden nun alle verfügbaren Bestellstati vom Webshop zu den Marktplätzen übermittelt. Der Prozess dauert 3-10 Minuten.<br>Der Vorgang läuft zusätzlich automatisch in 30-60 Minuten Intervallen im Hintergrund.';
