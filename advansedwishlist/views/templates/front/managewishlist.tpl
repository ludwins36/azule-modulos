...
{if $products}
    ...
    {/if}
             <div class="alert alert-success hidden ws_added_alert">{l s='Product successfully added to your shopping cart' mod='advansedwishlist'}</div>
