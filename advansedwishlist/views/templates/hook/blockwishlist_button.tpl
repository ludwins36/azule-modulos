...
{if $logged}
    ...
    <div class="wishlist {if $show_btn_top}wishlist_btn_top{/if}">
        <a data-id-product="{$ws_product.id_product|intval}" data-id-product-attribute="{$ws_product.id_product_attribute|intval}" class="open_wishlist_popup" href="#wishlist_popup_form"  title="{l s='Wishlist' mod='advansedwishlist'}">
			...
			{/if}
        {if $show_btn_text}{l s='Add to wishlist' mod='advansedwishlist'}{/if}
        </a>
    </div>
    {else}
        {if $issetProduct}
        <div class="wishlist wrap_allert {if $show_btn_top}wishlist_btn_top{/if}">
			...
			<i class="icon-heart"></i>
			{/if}
            {if $show_btn_text}{l s='Added to Wishlist' mod='advansedwishlist'}{/if}</a>
