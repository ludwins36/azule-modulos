...
class AdvansedwishlistViewModuleFrontController extends ModuleFrontController
{
    ...
    public function __construct()
    {
        ...
        include_once($this->module->getLocalPath().'advansedwishlist.php');
    }
        ...
        if ($token) {
            ...
            $this->context->smarty->assign(
                array(
                    ...
                    'wishlists' => $wishlists,
                    'products' => $products,
                    'advansedwishlist_controller_url' => '',
                )
            );
        }
        if (version_compare(_PS_VERSION_, '1.7', '>')) {
            $this->setTemplate('module:advansedwishlist/views/templates/front/view17.tpl');
        } else {
