                    ...
                    <tr>
                        ...
                        <td class='action_cell'>
                            ...
                            {if $value.response != 1}
						        ...
						        <button type='submit' value='{$value.id_vex_urbaner|escape:'html':'UTF-8'}' name='submitOrderDeleteAction' class='btn btn-default pull-right'>
                        	        {l s='    CANCELAR    ' mod='vexurbaner'}
                   		        </button>
