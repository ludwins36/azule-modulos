		...
		<div class='tab-pane active' id='page1'>
			<div class='panel' id='fieldset_0'>
            	...
            	<div class='form-wrapper'>
        			<input type='hidden' name='submitStoreIdUrbaner' value='1'/>
					<div class='form-group'>
                    	<label class='control-label col-lg-3'>{l s='Nombre de la Tienda' mod='vexurbaner'}</label>
                    	<div class='col-lg-6'>
                        	<input type='text'  name='name' />
							<p class='help-block'>{l s='Debe ser igaul al nombre del admin de la tienda.' mod='vexurbaner'}</p>
                	...
                	<div class='form-group'>
                    	...
                    	<div class='col-lg-6'>
							...
							<p class='help-block'>{l s='Descubre la Latitud y Longitud ' mod='vexurbaner'}<a role='button' target='_blank' href='https://www.latlong.net/'>{l s='AQUÍ' mod='vexurbaner'}</a></p>
